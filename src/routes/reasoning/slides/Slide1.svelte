...
<Slide {slideIndex}>
	...
	<ReferenceOverlay src="/export/01-Intro_Reasoning/Slide1.png" />

	<!-- ===== STATIC CONTENT (Always visible) ===== -->
	
	<!-- Quote text box with light gray background -->
	...
	<Fragment
		...
		font={{ font_size: 23.3, alignment: 'left' }}
