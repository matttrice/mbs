...
<Slide {slideIndex}>
	...
	<!-- Static: Title -->
	<Fragment
		layout={{ x: 332, y: 19, width: 296, height: 62 }}
		font={{ align: 'center', font_size: 48.3, bold: true }}
		zIndex={4}
	>
		Translation
	</Fragment>

	<!-- Step 1: Einstein matter/energy box -->
	<Fragment
		step={1}
		layout={{ x: 385, y: 86, width: 191, height: 123 }}
		font={{ v_align: 'middle', font_size:22, align: 'center', wrap: true }}
		fill="var(--bg-level-1)"
		line={{ width: 4 }}
		zIndex={3}
	>
		Einstein proved<br>matter and energy<br>are convertible<br>currency
	</Fragment>
	...
	<Fragment
		...
		font={{ font_size: 48.3, font_name: 'Arial Black', v_align: 'middle', align: 'center' }}
		fill="white"
		line={{ width: 1, color: 'var(--stroke-level-0)' }}
		zIndex={29}
	>
		<strong style="color: var(--text-level-3)">E</strong><span style="color: var(--text-level-0)">=</span><strong><span style="color: var(--text-level-0)">M</span><span style="color: var(--text-level-3)">C</span></strong><sup style="color: var(--text-level-3)">2</sup>
	</Fragment>
	...
	<Fragment
		...
		font={{ v_align: 'middle', align: 'center', font_size: 66.7, bold: true, color: 'var(--text-level-3)' }}
		zIndex={30}
	>
		Spiritual
	</Fragment>
	...
	<Fragment
		step={2}
		layout={{ x: 45, y: 432, width: 279, height: 72 }}
		font={{ v_align: 'middle', align: 'center', font_size: 66.7, bold: true }}
		zIndex={2}
	>
		Physical
	</Fragment>

	<!-- Step 3: Enter arrow (thick black horizontal bar) -->
	<Fragment step={3} animate="wipe-left">
		<Arrow from={{ x: 890, y: 360 }} to={{ x: 372, y: 359 }} stroke={{ width: 35, color: 'var(--stroke-level-0)' }} zIndex={0} />
	</Fragment>

	<!-- Step 3: Enter label -->
	<Fragment
		step={3}
		layout={{ x: 580, y: 325, width: 141, height: 67 }}
		font={{ font_size: 40, bold: true, color: '#FFFFFF' }}
		zIndex={32}
	>
		<strong>Enter</strong>
	</Fragment>

	<!-- Step 3: Incarnation (underlined, drillTo) -->
	<Fragment
		step={4}
		drillTo="translation/incarnation"
		layout={{ x: 75, y: 22, width: 229, height: 56 }}
	...
	<!-- Step 4: Genesis 3:1-5, 8 (click-only) -->
	<Fragment
		step={4}
		clickTo="translation/genesis-3-1-5"
		layout={{ x: 79, y: 72, width: 170, height: 32 }}
	...
	<!-- Step 4: Serpent, heard Lord walking -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Genesis 18:1-2 3 (click-only) -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Visitors surprise Abraham -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Exodus 33:21-23 (click-only) -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Moses protected from glory of God -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Numbers 22:29-33 (click-only) -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Ezekiel 1:25;8:1 Daniel 10:4 (click-only) -->
	<Fragment
		step={4}
	...
	<!-- Step 4: glowing metal, chrysolite -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Acts 10:30-31 (click-only) -->
	<Fragment
		step={4}
	...
	<!-- Step 4: Paul blinded by light on Damascus road -->
	<Fragment
		step={4}
	...
	<Fragment step={5} animate="wipe-right">
		<Arrow from={{ x: 330, y: 468 }} to={{ x: 618, y: 468 }} stroke={{ width: 35, color: 'var(--stroke-level-3)' }} zIndex={1} />
	</Fragment>
