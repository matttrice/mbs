...
<Slide>
	...
	<!-- Static: Scripture -->
	<Fragment
		layout={{ x: 109, y: 92, width: 791, height: 105 }}
	...
	<!-- Step 1: Leviticus 16:15-16 (timing: click) -->
	<Fragment
		step={1}
		layout={{ x: 109, y: 235, width: 779, height: 244 }}
		font={{ font_size: 33.3, bold: true, align: 'left', wrap: true }}
	>
		Leviticus 16:15-1615 "He shall then slaughter the goat for the sin offering for the people and take its blood behind the curtain and do with it as he did with the bull's blood: He shall sprinkle it on the atonement cover and in front of it. 16 In this way he will make atonement for the Most Holy Place because of the uncleanness and rebellion of the Israelites, whatever their sins have been. He is to do the same for the tent of meeting, which is among them in the midst of their uncleanness. NIV
	</Fragment>
</Slide>
