...
<Slide {slideIndex}>
	...
	<Fragment
		...
		font={{ font_size: 21.7, italic: true, align: 'left', v_align: 'middle' }}
		line={{ width: 1 }}
	>
	...
	<Fragment step={1} animate="draw">
		<Arc from={{ x: 84, y: 518 }} to={{ x: 424, y: 512 }} curve={-161} stroke={{ width: 8, color: '#000000' }} zIndex={1} />
	</Fragment>
	...
	<Fragment
		...
		layout={{ x: 361, y: 314, width: 243, height: 105 }}
	...
	<!-- Step 5: Orange ark shape (right side - Church) -->
	<Fragment step={5} animate="draw">
		<Arc from={{ x: 518, y: 522 }} to={{ x: 858, y: 515 }} curve={-169} stroke={{ width: 8, color: '#000000' }} zIndex={2} />
	</Fragment>

	<!-- Step 5.1: Christ "sat down" label (timing: after) -->
	<Fragment
		step={5.1}
		layout={{ x: 616, y: 322, width: 159, height: 72 }}
		font={{ font_size: 26.7, bold: true, align: 'center' }}
		line={{ width: 1 }}
	>
		Christ "sat down"
	...
	<Fragment
		step={6}
		layout={{ x: 599, y: 270, width: 203, height: 51 }}
		fill="#000000"
		font={{ font_size: 35, bold: true, color: '#F4F4F4', align: 'center' }}
		line={{ width: 1 }}
	>
	...
	<Fragment
		step={7}
		layout={{ x: 616, y: 396, width: 161, height: 40 }}
		font={{ font_size: 26.7, bold: true, align: 'left' }}
		line={{ width: 1 }}
	>
		Mount Zion
