...
<Fragment
	step={1}
	layout={{ x: 95, y: 44, width: 810, height: 26 }}
	font={{ font_size: 15 }}
	zIndex={1}
>
	<ScriptureBlock>
...
<Fragment
	step={2}
	layout={{ x: 95, y: 69, width: 810, height: 44 }}
...
<!-- Step 3: Matthew 10:28 (is_scripture) -->
<Fragment
	step={3}
	layout={{ x: 95, y: 112, width: 810, height: 44 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={3}
>
	<ScriptureBlock>
...
<!-- Step 4: Acts 2:27 (is_scripture) -->
<Fragment
	step={4}
	layout={{ x: 95, y: 156, width: 775, height: 26 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={4}
>
	<ScriptureBlock>
...
<!-- Step 5: Acts 2:41 (is_scripture) -->
<Fragment
	step={5}
	layout={{ x: 95, y: 180, width: 810, height: 44 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={5}
>
	<ScriptureBlock>
...
<!-- Step 6: Hebrews 4:12 (is_scripture) -->
<Fragment
	step={6}
	layout={{ x: 95, y: 223, width: 810, height: 44 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={6}
>
	<ScriptureBlock>
...
<!-- Step 7: Hebrews 10:39 (is_scripture) -->
<Fragment
	step={7}
	layout={{ x: 95, y: 266, width: 810, height: 44 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={7}
>
	<ScriptureBlock>
...
<!-- Step 8: Hebrews 13:17 (is_scripture) -->
<Fragment
	step={8}
	layout={{ x: 95, y: 309, width: 810, height: 44 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={8}
>
	<ScriptureBlock>
...
<!-- Step 9: James 1:21 (is_scripture) -->
<Fragment
	step={9}
	layout={{ x: 95, y: 352, width: 810, height: 44 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={9}
>
	<ScriptureBlock>
...
<!-- Step 10: James 5:20 (is_scripture) -->
<Fragment
	step={10}
	layout={{ x: 95, y: 396, width: 810, height: 44 }}
	font={{ align: 'left', v_align: 'middle', wrap: true }}
	zIndex={10}
>
	<ScriptureBlock>
